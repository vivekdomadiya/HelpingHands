    ...
    <div class="container content">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 text-center mx-auto">
                    ...
                    <c:if test="${error}">
                    <div class="alert alert-danger">We didn't find an account for that e-mail address. <br><a class="link" href="/sign-up">sign up here</a>.</div>
                    </c:if>
                    ...
                    <form id="forgetPassForm" role="form" autocomplete="off" class="form" method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input id="email" name="email" placeholder="email address" class="form-control" value="${email}"  type="email" autofocus required>
                            </div>
                    ...
                    <c:if test="${success}">
                    <div class="alert alert-success">Reset Password link sent to your email address.<br>Please Check your mail box.</div>
                    </c:if>
            </div>
        </div>  <!-- /.row -->
    </div>  <!-- /.container -->
